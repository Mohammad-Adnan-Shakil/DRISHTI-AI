...
async def run_migrations():
    ...
    async with engine.begin() as conn:
        ...
        # Referrals columns
        await conn.execute(text("ALTER TABLE referrals ADD COLUMN IF NOT EXISTS doctor_name VARCHAR DEFAULT 'Dr. Arjun Sharma';"))
        await conn.execute(text("UPDATE referrals SET doctor_name = 'Dr. Arjun Sharma' WHERE doctor_name IS NULL;"))
