...
const GRADE_CONFIG = {
  0: {
    ...
    findings: 'No microaneurysms, hemorrhages, or exudates detected.',
    recommendationTitle: 'Routine Annual Follow-up at PHC',
    recommendation: 'Continue routine annual screening at PHC.',
  ...
  1: {
    ...
    findings: 'Few microaneurysms detected in inferior-temporal arcade.',
    recommendationTitle: '6-Month Surveillance & Glycemic Review',
    recommendation: 'Re-screen at PHC in 6 months and optimize glycemic control.',
  ...
  2: {
    ...
    findings: 'Microaneurysms and dot hemorrhages detected in inferior-temporal quadrant.',
    recommendationTitle: 'Refer patient for ophthalmologist evaluation',
    recommendation: 'Refer to District/Taluk Hospital eye OPD for dilated fundus examination.',
  ...
  3: {
    ...
    findings: 'Extensive hemorrhages and venous beading detected across multiple quadrants.',
    recommendationTitle: 'Urgent Ophthalmology Referral Required',
    recommendation: 'Refer urgently to District Ophthalmic Center within 1–2 weeks.',
  ...
  4: {
    ...
    findings: 'Neovascularization and risk of vitreous hemorrhage detected.',
    recommendationTitle: 'Immediate Specialist Referral & Intervention',
    recommendation: 'Refer immediately to a tertiary eye institute for urgent treatment.',
